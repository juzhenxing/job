...
//        System.out.printf("preHandle被调用");
        ...
        Object administratorPo = httpSession.getAttribute("administratorPo");
        if(administratorPo == null){
            String errorMessage = java.net.URLEncoder.encode("您还未登录","utf-8");
            httpServletResponse.sendRedirect(httpServletRequest.getContextPath() + "/administrator/login?errorMessage=" + errorMessage);
            return false;
        }
